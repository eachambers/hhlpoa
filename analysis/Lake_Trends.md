...
- [Water chemistry](#water-chemistry)
  - [Dissolved O2 and temperature](#dissolved-o2-and-temperature)
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-4-2.png)<!-- -->
...
```
    ...
    ## Year2025     -0.3840        NaN     NaN      NaN
    ## Year2026     -0.0870        NaN     NaN      NaN
    ## 
    ## Residual standard error: NaN on 0 degrees of freedom
    ## Multiple R-squared:      1,  Adjusted R-squared:    NaN 
    ## F-statistic:   NaN on 30 and 0 DF,  p-value: NA
...
```
    ...
    ## Year1997    -1.278e-15        NaN     NaN      NaN
    ...
    ## Year2025    -2.900e-02        NaN     NaN      NaN
    ## Year2026     8.000e-03        NaN     NaN      NaN
    ## 
    ## Residual standard error: NaN on 0 degrees of freedom
    ## Multiple R-squared:      1,  Adjusted R-squared:    NaN 
...
```
    ...
    ## ── Column specification ────────────────────────────────────────────────────────
    ## Delimiter: "\t"
    ## chr (3): lake, date, depth_m
    ## dbl (4): nitrate, alkalinity, pH, conductivity
    ## 
    ## ℹ Use `spec()` to retrieve the full column specification for this data.
    ## ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
...
```
    ...
    ## # A tibble: 3 × 3
    ##   lake        `min(nitrate)` `max(nitrate)`
    ##   <chr>                <dbl>          <dbl>
    ## 1 Big_Hawk              0.02          0.048
    ## 2 Halls                 0.02          0.06 
    ## 3 Little_Hawk           0.02          0.078
...
```
    ...
    ##   lake        `min(pH)` `max(pH)`
    ##   <chr>           <dbl>     <dbl>
    ## 1 Big_Hawk         6.78      8.84
    ## 2 Halls            7.13      8.08
    ## 3 Little_Hawk      6.97      8.02
...
```
    ...
    ## # A tibble: 3 × 3
    ##   lake        `min(alkalinity)` `max(alkalinity)`
    ##   <chr>                   <dbl>             <dbl>
    ## 1 Big_Hawk                 3.92              8.35
    ## 2 Halls                    4.5               6.7 
    ## 3 Little_Hawk              3.95              8.25
...
```
    ...
    ## # A tibble: 3 × 3
    ##   lake        `min(conductivity)` `max(conductivity)`
    ##   <chr>                     <dbl>               <dbl>
    ## 1 Big_Hawk                   14.4                36.5
    ## 2 Halls                      19.6                41.2
    ## 3 Little_Hawk                12.8                38.3
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-12-2.png)<!-- -->
...
```
    ...
    ## `summarise()` has regrouped the output.
    ## ℹ Summaries were computed grouped by Lake Name and Year.
    ## ℹ Output is grouped by Lake Name.
    ## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
    ## ℹ Use `summarise(.by = c(Lake Name, Year))` for per-operation grouping
    ##   (`?dplyr::dplyr_by`) instead.

![](Lake_Trends_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
```
    ...
    ## # A tibble: 154 × 6
    ##     Year Lake  Biotic_index   avg_value site_code_norep `Lake Name`     
    ##    <dbl> <chr> <chr>              <dbl> <chr>           <chr>           
    ##  1  2022 Halls Simpsons_Index      0.18 HALL-17         Halls Lake      
    ##  2  2021 Hawk  Simpsons_Index      0.18 BHWK-04         Big Hawk Lake   
    ##  3  2021 Hawk  Simpsons_Index      0.31 LHWK-04         Little Hawk Lake
    ##  4  2020 Halls Simpsons_Index      0.32 HALL-09         Halls Lake      
    ##  5  2021 Hawk  Simpsons_Index      0.37 BHWK-05         Big Hawk Lake   
    ##  6  2021 Hawk  Simpsons_Index      0.38 BHWK-04         Big Hawk Lake   
    ##  7  2022 Hawk  Simpsons_Index      0.38 BHWK-03         Big Hawk Lake   
    ##  8  2022 Hawk  Simpsons_Index      0.38 BHWK-05         Big Hawk Lake   
    ##  9  2019 Halls Simpsons_Index      0.4  HALL-04         Halls Lake      
    ## 10  2019 Halls Simpsons_Index      0.4  HALL-08         Halls Lake      
    ## # ℹ 144 more rows
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
```
    ...
    ## ── Column specification ────────────────────────────────────────────────────────
    ## Delimiter: "\t"
    ## chr (4): Lake, Order, Common_name, site_name
    ## dbl (2): Year, number
    ## 
    ## ℹ Use `spec()` to retrieve the full column specification for this data.
    ## ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
...
Recall that the mHBI measures the proportion of pollutant *tolerant*
organisms
...
```
    ...
    ##  1 Halls Lake    mHBI          2019  2023  0     3.75 Excellent  
    ##  2 Halls Lake    mHBI          2019  2023  3.75  4.25 Very good  
    ##  3 Halls Lake    mHBI          2019  2023  4.25  5    Good       
    ##  4 Halls Lake    mHBI          2019  2023  5     5.75 Fair       
    ##  5 Halls Lake    mHBI          2019  2023  5.75  6.5  Fairly poor
    ##  6 Halls Lake    mHBI          2019  2023  6.5   7.25 Poor       
    ##  7 Halls Lake    mHBI          2019  2023  7.25 10    Very poor  
    ##  8 Big Hawk Lake mHBI          2020  2024  0     3.75 Excellent  
    ##  9 Big Hawk Lake mHBI          2020  2024  3.75  4.25 Very good  
    ## 10 Big Hawk Lake mHBI          2020  2024  4.25  5    Good       
    ## # ℹ 11 more rows
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-43-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-43-2.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-46-1.png)<!-- -->
...
We can compare our ice out dates to those from Algonquin Park (found
here: <https://www.algonquinpark.on.ca/news/ice-out.php>)
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = doy ~ Year, data = algonquin)
    ## 
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -27.0550  -3.9737   0.8492   5.2664  16.0069 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)   
    ## (Intercept) 420.26736  128.77542   3.264  0.00182 **
    ## Year         -0.15170    0.06456  -2.350  0.02210 * 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 9.097 on 60 degrees of freedom
    ## Multiple R-squared:  0.08426,    Adjusted R-squared:  0.06899 
    ## F-statistic: 5.521 on 1 and 60 DF,  p-value: 0.0221
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-50-1.png)<!-- -->
...
![](Lake_Trends_files/figure-gfm/unnamed-chunk-51-1.png)<!-- -->
