...
ggsave(here("plots", "ice_out.pdf"), width = 10, height = 6)
```
...
# dat <- terra::as.data.frame(subset, xy = TRUE)

unique(dat$OLCC_V2_TIFF)
subset[subset == 247] <- NA

# TODO add manual coloration in here
ggplot() +
